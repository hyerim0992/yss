...
<header class="ys-global-header"
        data-global-header
        data-context-path="${ctx}"
        data-server-authenticated="${isMember}"
        data-login-url="${ctx}/member/login"
        data-mypage-url="${ctx}/mypage"
          ...
          <div class="row align-items-center">
            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3 ys-header-logo-column">
              <div class="logo ys-header-logo">
                <a href="${ctx}/index.jsp" class="ys-header-logo-link" aria-label="용신사 홈으로 이동"><img src="${ctx}/dist/images/logo/logo.png" alt="YONGSINSA"></a>
              </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-8 col-md-7 col-sm-5">
              <div class="main-menu f-right d-none d-lg-block">
                <nav>
                  <ul id="navigation">
                    <li>
                      <a href="${ctx}/product/category?sort=new">NEW</a>
                      <ul class="submenu">
                    ...
                    <li>
                      <a href="${ctx}/product/category?audience=man">MAN</a>
                      <ul class="submenu">
                    ...
                    <li>
                      <a href="${ctx}/product/category?audience=woman">WOMAN</a>
                      <ul class="submenu">
                    ...
                    <li>
                      <a href="${ctx}/product/category?audience=kids">KIDS</a>
                      <ul class="submenu">
                    ...
                    <li class="d-lg-none ${isMember ? 'is-hidden' : ''}" data-mobile-login-item>
                      <a href="${ctx}/member/login" data-login-link>로그인</a>
                    </li>
                    <li class="d-lg-none ${isMember ? '' : 'is-hidden'}" data-mobile-logout-item>
                      <a href="${ctx}/member/logout" data-logout-link>로그아웃</a>
                    </li>
                  </ul>
                </nav>
              </div>
              ...
              <ul class="header-right f-right d-none d-lg-block d-flex justify-content-between">
                <li class="d-none d-xl-block header-search-item">
                  <div class="form-box f-right">
                    <input type="text" name="Search" placeholder="Search products" readonly autocomplete="off" data-open-search aria-label="상품 검색 열기">
                    <div class="search-icon" data-open-search role="button" tabindex="0" aria-label="상품 검색 열기">
                ...
                <li class="d-none d-xl-block">
                  <div class="favorit-items">
                    <a href="${ctx}/mypage#wishlist" aria-label="위시리스트" data-mypage-section-link="wishlist"><i class="far fa-heart"></i></a>
                  </div>
                </li>
                <li>
                  <div class="shopping-card">
                    <a href="${ctx}/mypage#cart" aria-label="장바구니" data-mypage-section-link="cart"><i class="fas fa-shopping-cart"></i></a>
                  </div>
                </li>
                <li class="d-none d-xl-block header-mypage-item">
                  <a href="${ctx}/mypage" class="header-auth-link" data-mypage-link>MYPAGE</a>
                </li>
                <li class="d-none d-lg-block ${isMember ? 'is-hidden' : ''}" data-desktop-login-item>
                  <a href="${ctx}/member/login" class="btn header-btn" data-login-link>로그인</a>
                </li>
                <li class="d-none d-lg-block ${isMember ? '' : 'is-hidden'}" data-desktop-logout-item>
                  <a href="${ctx}/member/logout" class="btn header-btn" data-logout-link>로그아웃</a>
                </li>
              </ul>
            </div>
