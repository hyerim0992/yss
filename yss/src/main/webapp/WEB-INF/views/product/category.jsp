...
<script src="${pageContext.request.contextPath}/dist/js/vendor/jquery-1.12.4.min.js"></script>
<script src="${pageContext.request.contextPath}/dist/js/vendor/popper.min.js"></script>
<script src="${pageContext.request.contextPath}/dist/js/vendor/bootstrap.min.js"></script>
